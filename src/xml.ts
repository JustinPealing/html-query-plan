/**
 * Parses the given XML string into an XML dom in preparation to apply XSLT.
 ...
 */
function setContentsUsingXslt(container: Element, xmlDoc, xslt: string) {
    if ((<any>window).ActiveXObject || "ActiveXObject" in window) {
        ...
        let result = xsltProcessor.transformToFragment(xmlDoc, document);
        container.innerHTML = "";
        container.appendChild(result);
    }
}

export { setContentsUsingXslt, parse }